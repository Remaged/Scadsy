		...
		<td class="module">
			...
			<div class="sc-module-actions">
				<?php if ($module->status == 'disabled') { 
					echo post_link("module/module/enable", "Enable", array("module" => $module->directory), "showNotification('succes', 'Module has been enabled!');");
				} else if ($module->status == 'enabled') { 
					echo post_link("module/module/disable", "Disable", array("module" => $module->directory), "showNotification('succes', 'Module has been disabled!');");
				} else if ($module->status == 'not_installed') { 
					echo post_link("module/module/install", "Install", array("module" => $module->directory), "showNotification('succes', 'Module has been installed!');");
				} ?>
			</div>
		</td>	
		<td>
